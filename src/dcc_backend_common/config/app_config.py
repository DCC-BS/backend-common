...
class LlmConfig(AbstractAppConfig):
    ...
    llm_timeout: int = Field(description="The timeout for LLM API requests in seconds")
    llm_max_retries: int = Field(description="The maximum number of retries for LLM API requests")
